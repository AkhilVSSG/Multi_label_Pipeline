...
def train_fastxml():
    ...
    os.system(". fastxml/Fastxml/bin/activate && fxml.py ../static/models/FastXML/Fastxml.model ../data/train.json --verbose train --iters 2000 --trees 40 --label-weight propensity --alpha 1e-4 --leaf-classifiers")      
